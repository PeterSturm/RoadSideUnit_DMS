...
public class RSUAgent
{
    ...
    public RSUAgent(String ip, String port, String trapaddress, String trapuser, String trapauth, String trappriv, String telnetip, String telnetuser, String telnetpass) throws ConnectException
    {
        IP = ip;
        Port = port;
        TrapAddress = trapaddress;
        ...
        if(TelnetIP != null && TelnetIP != "")
        {
            try {
                ...
                // Execute "stp-print" command ang get the result
                String result = telnet.executeCommand("stp-print");
